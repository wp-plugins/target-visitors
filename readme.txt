...
7. If you want to show message on another pages (like search.php, archives.php) place this code: `lt;? if(function_exists('wp_target_visitors')) wp_target_visitors(); ?>` in your templates.
